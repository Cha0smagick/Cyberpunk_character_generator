...
respuesta_bot = obtener_respuesta("Al principio lee la informacion que te dare a continuacion y genera un SOLO parrafo con toda la siguiente informacion de seguido: nombre del personaje, el sexo, color de piel, la descripcion fisica minuciosa de la cara y cuerpo del personaje con detalles y minucias minimas notables unicas que debes inventar al azar segun el background del personaje, describiendo la cara y el traje del personaje segun su profesion, de manera obligatoria. Alarga ese unico parrafo lo mas que puedas describiendo detalles unicos e inventando un background de acuerdo a los atributos, crianza infancia y lugares relacionados al personaje. esto debe ir en un unico parrafo empezando el output, y debe contener tambien la ocupacion y las habilidades y defectos del personaje en ese parrafo unico. Se especifico con esa informacion y formateala de manera que el primer parrafo sea un prompt para una IA que genera arte. despues de que hagas esto, debes generar la hoja de rol de un personaje cyberpunk completo a partir de la informacion imputada a continuacion. Eso debe hacerse siguiendo este formato: Nombre:  Genero: Raza: Edad  Profesión: Color de piel (inventa uno):  Alineación moral: Descripción física y facial detallada con características únicas: Facción: Background (unico y mínimo 500 palabras): Stats del personaje. Habilidades del personaje (mínimo 10 habilidades medibles de 1 a 20). Hechizos del personaje (mínimo 5 hechizos medibles de 1 a 20). Habilidades (5 talentos, 5 técnicas y 5 conocimientos relevantes). Ventajas (5 disciplinas, 5 trasfondos y 5 virtudes). Genera toda esta información y no sugieras añadir informacion, sino añadela tu, inventatela si es necesario, en un formato de hoja de personaje de juego de rol que debes optimizar a partir de la informacion que te proporciono a continuación:  \n\n" + contenido_filtrado, chat)
